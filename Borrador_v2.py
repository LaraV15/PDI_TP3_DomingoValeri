...
# Crear una imagen en blanco para dibujar las líneas (mismo tamaño que f_mg)
...
# Separar las líneas detectadas en lado izquierdo y derecho
for line in lines:
    x1, y1, x2, y2 = line[0]
    # Determinar si la línea está en el lado izquierdo o derecho
    if x1 < f_mg.shape[1] / 2 and x2 < f_mg.shape[1] / 2:
        left_lines.append((x1, y1, x2, y2))
    else:
        right_lines.append((x1, y1, x2, y2))

# Dibujar las líneas del lado izquierdo
for line in left_lines:
    x1, y1, x2, y2 = line
    cv2.line(f_mg, (x1, y1), (x2, y2), (0, 255, 0), 2)

# Superponer las líneas sobre la imagen original
combined_image = cv2.addWeighted(frame, 0.8, f_mg, 1, 0)
